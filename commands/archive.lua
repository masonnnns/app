...
command.execute = function(message,args,client)
  ...
  local msgs = {}
  for a,items in pairs(message.channel:getMessages(tonumber(args[2])+1)) do if items.id == message.id then else msgs[1+#msgs] = {items.createdAt,items.author.tag.." ("..items.id.."): "..items.content} end end
